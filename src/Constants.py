...
class C:
	...
	TIME_STARTER_WHITE = (10,0)
	TIME_BONUS_WHITE   = 0

	TIME_STARTER_BLACK = (10,0)
	TIME_BONUS_BLACK   = 0
	...
	PANE_HEIGHT = BOARD_HEIGHT
	PANE_SIZE   = (PANE_WIDTH + PANE_GAP , PANE_HEIGHT)
	...
	GAUGE_WIDTH  = 20
	GAUGE_HEIGHT = BOARD_HEIGHT
	GAUGE_SIZE   = (GAUGE_WIDTH , GAUGE_HEIGHT)

	GRAVE_WIDTH  = BUTTON_WIDTH
	GRAVE_HEIGHT = BOARD_HEIGHT
	GRAVE_SIZE   = (GRAVE_WIDTH , GRAVE_HEIGHT)

	SHELF_WIDTH  = SIDEBAR_WIDTH - GRAVE_WIDTH
	SHELF_HEIGHT = BOARD_HEIGHT
	SHELF_SIZE   = (SHELF_WIDTH , SHELF_HEIGHT)

	TRAY_GAP = 8*GRID_GAP

	TRAY_WIDTH  = GAUGE_WIDTH + GRAVE_WIDTH + SHELF_WIDTH
	TRAY_HEIGHT = BOARD_HEIGHT
	TRAY_SIZE   = (TRAY_GAP + TRAY_WIDTH , TRAY_HEIGHT)

	TRAY_OFFSET = PANE_WIDTH + BOARD_WIDTH - TRAY_GAP

	TEXTBOX_WIDTH  = 225
	TEXTBOX_HEIGHT = 18
	TEXTBOX_SIZE   = (TEXTBOX_WIDTH , TEXTBOX_HEIGHT)

	WINDOW_WIDTH  = PANE_WIDTH + BOARD_WIDTH + TRAY_WIDTH
	...
	BUTTON_LOCK = (115,115,115)

	BUTTON_COUNTER_LIVE = (225,225,225,25)
	BUTTON_COUNTER_IDLE = (  0,  0,  0,75)

	TEXTBOX_LIVE = ( 60, 60, 70)
	TEXTBOX_LOOM = ( 90, 90,100)
	TEXTBOX_IDLE = (100,105,105)
...
class E:
	...
	WHITE_DIFFICULTY = 2		### out of 9
	BLACK_DIFFICULTY = 2		### out of 9

	BOT_GAUGE = None
	BOT_LINES = [False,False,False]
